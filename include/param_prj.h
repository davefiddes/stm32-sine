...
#define MOTOR_PARAMETERS_COMMON \
    ...
    PARAM_ENTRY(CAT_MOTOR,   encmode,     ENCMODES,  0,      6,      0,      75  ) \
    ...
    PARAM_ENTRY(CAT_MOTOR,   snsm,        SNS_M,     12,     24,     12,     46  ) \
...
#define THROTTLE_PARAMETERS_COMMON \
    ...
    PARAM_ENTRY(CAT_THROTTLE,potlinearity,"%",       0,      100,    100,    169 ) \
...
#define VALUE_BLOCK2 \
    ...
    VALUE_ENTRY(m3_phaseA_hi, TESLAM3GATESTATUS, 2057 ) \
    VALUE_ENTRY(m3_phaseA_lo, TESLAM3GATESTATUS, 2058 ) \
    VALUE_ENTRY(m3_phaseB_hi, TESLAM3GATESTATUS, 2059 ) \
    VALUE_ENTRY(m3_phaseB_lo, TESLAM3GATESTATUS, 2060 ) \
    VALUE_ENTRY(m3_phaseC_hi, TESLAM3GATESTATUS, 2061 ) \
    VALUE_ENTRY(m3_phaseC_lo, TESLAM3GATESTATUS, 2062 ) \
...
#define SNS_HS       "0=JCurve, 1=Semikron, 2=MBB600, 3=KTY81, 4=PT1000, 5=NTCK45_2k2, 6=Leaf, 7=BMW-i3, 8=TeslaM3"
#define SNS_M        "12=KTY83-110, 13=KTY84-130, 14=Leaf, 15=KTY81-110, 16=Toyota, 21=OutlanderFront, 22=EpcosB57861-S, 23=ToyotaGen2, 24=TeslaM3"
...
#define ENCMODES     "0=Single, 1=AB, 2=ABZ, 3=SPI, 4=Resolver, 5=SinCos, 6=HFResolver"
...
#define HWREVS       "0=Rev1, 1=Rev2, 2=Rev3, 3=Tesla, 4=BluePill, 5=Prius, 6=MiniMainboard, 7=Leaf2, 8=Leaf3, 9=BMWi3, 10=Zoe, 11=MG, 12=TeslaM3RDU, 13=TeslaM3FDU"
