...
#define CAN2_BLKNUM     4   //second to last block of 1k
...
typedef enum
{
   HW_REV1, HW_REV2, HW_REV3, HW_TESLA, HW_BLUEPILL, HW_PRIUS, HW_MINI, HW_LEAF2, HW_LEAF3, HW_BMWI3, HW_ZOE, HW_MG, HW_TESLAM3RDU, HW_TESLAM3FDU
} HWREV;
